...
public class ActivityAddVipBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.add_vip_card_type, 12);
        sViewsWithIds.put(R.id.tv3, 13);
        sViewsWithIds.put(R.id.ll_add_vip_select, 14);
        sViewsWithIds.put(R.id.rg_add_vip_birthday, 15);
        sViewsWithIds.put(R.id.rb_add_vip_select_birthday, 16);
        sViewsWithIds.put(R.id.rb_add_vip_not_select_birthday, 17);
        sViewsWithIds.put(R.id.ll_add_vip_birthday, 18);
        sViewsWithIds.put(R.id.ll_add_vip_employee, 19);
    }
    // views
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.vip.AddVipViewModel mViewModel;
    @Nullable
    ...
    private android.databinding.InverseBindingListener cardNoEtandroidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.vip.AddVipViewModel viewModel = mViewModel;
            // viewModel != null
    ...
    public ActivityAddVipBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.addVipCardType = (android.widget.RelativeLayout) bindings[12];
        ...
        this.llAddVipBirthday = (android.widget.LinearLayout) bindings[18];
        this.llAddVipEmployee = (android.widget.LinearLayout) bindings[19];
        this.llAddVipSelect = (android.widget.LinearLayout) bindings[14];
        ...
        this.rbAddVipNotSelectBirthday = (android.widget.RadioButton) bindings[17];
        this.rbAddVipSelectBirthday = (android.widget.RadioButton) bindings[16];
        this.rgAddVipBirthday = (android.widget.RadioGroup) bindings[15];
        ...
        this.textView = (android.widget.TextView) bindings[11];
        this.tv3 = (android.widget.TextView) bindings[13];
        this.vipTypeTv = (android.widget.EditText) bindings[6];
        this.vipTypeTv.setTag(null);
        setRootTag(root);
        // listeners
        mCallback49 = new android.databinding.generated.callback.OnClickListener(this, 2);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.vip.AddVipViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.vip.AddVipViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.vip.AddVipViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 6 :
                return onChangeViewModel((ys.app.pad.viewmodel.vip.AddVipViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.vip.AddVipViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x40L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x80L) != 0) {
            ...
            this.addVipBirthdayName.setOnClickListener(mCallback49);
            ...
            this.ivDialogSearchCard.setOnClickListener(mCallback48);
        ...
        if ((dirtyFlags & 0xc0L) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setTextChangedListener(this.cardNoEt, viewModelTextChangeListener);
            ...
            ys.app.pad.utils.PetBindingUtil.setTextChangedListener(this.nameEt, viewModelTextChangeListener);
            ...
            ys.app.pad.utils.PetBindingUtil.setTextChangedListener(this.telEt, viewModelTextChangeListener);
            this.vipTypeTv.setOnClickListener(viewModelClickSelectButtonAndroidViewViewOnClickListener);
            ys.app.pad.utils.PetBindingUtil.setTextChangedListener(this.vipTypeTv, viewModelTextChangeListener);
        }
        if ((dirtyFlags & 0xd0L) != 0) {
            // api target 1
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.AddVipViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.vip.AddVipViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.AddVipViewModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.vip.AddVipViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl2 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.AddVipViewModel value;
        public OnClickListenerImpl2 setValue(ys.app.pad.viewmodel.vip.AddVipViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static ActivityAddVipBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityAddVipBinding>inflate(inflater, ys.app.pad.R.layout.activity_add_vip, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityAddVipBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_add_vip, null, false), bindingComponent);
    }
    @NonNull
