...
public class FragmentVipCardBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.vip.VipCardFragmentViewModel mViewModel;
    // values
    // listeners
    private OnClickListenerImpl mViewModelOnClickNetWorkErrorAndroidViewViewOnClickListener;
    // Inverse Binding Event Handlers

    public FragmentVipCardBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.vip.VipCardFragmentViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.vip.VipCardFragmentViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.vip.VipCardFragmentViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewModel((ys.app.pad.viewmodel.vip.VipCardFragmentViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.vip.VipCardFragmentViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.vip.VipCardFragmentViewModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.VipCardFragmentViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.vip.VipCardFragmentViewModel value) {
            this.value = value;
    ...
    @NonNull
    public static FragmentVipCardBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static FragmentVipCardBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<FragmentVipCardBinding>inflate(inflater, ys.app.pad.R.layout.fragment_vip_card, root, attachToRoot, bindingComponent);
    }
    @NonNull
    public static FragmentVipCardBinding inflate(@NonNull android.view.LayoutInflater inflater) {
        return inflate(inflater, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static FragmentVipCardBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.fragment_vip_card, null, false), bindingComponent);
    }
    @NonNull
    public static FragmentVipCardBinding bind(@NonNull android.view.View view) {
        return bind(view, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static FragmentVipCardBinding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        if (!"layout/fragment_vip_card_0".equals(view.getTag())) {
            throw new RuntimeException("view tag isn't correct on view:" + view.getTag());
        }
        return new FragmentVipCardBinding(bindingComponent, view);
    }
    /* flag mapping
