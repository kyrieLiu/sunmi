...
public class ActivityChargeBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    @NonNull
    public final ys.app.pad.widget.LastInputEditText moneyEt;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.ChargeViewModel mViewModel;
    @Nullable
    ...
    private android.databinding.InverseBindingListener mboundView5androidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.ChargeViewModel viewModel = mViewModel;
            // viewModel != null
    ...
    public ActivityChargeBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.moneyEt = (ys.app.pad.widget.LastInputEditText) bindings[3];
        ...
        setRootTag(root);
        // listeners
        mCallback47 = new android.databinding.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.ChargeViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.ChargeViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.ChargeViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 7 :
                return onChangeViewModel((ys.app.pad.viewmodel.ChargeViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.ChargeViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x80L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x180L) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setTextChangedListener(this.mboundView6, viewModelTextChangeListener);
            ys.app.pad.utils.PetBindingUtil.setTextChangedListener(this.moneyEt, viewModelTextChangeListener);
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.ChargeViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.ChargeViewModel value) {
            this.value = value;
    ...
    public static ActivityChargeBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityChargeBinding>inflate(inflater, ys.app.pad.R.layout.activity_charge, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityChargeBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_charge, null, false), bindingComponent);
    }
    @NonNull
