...
public class ItemAppointmentBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    // variables
    @Nullable
    private ys.app.pad.itemmodel.AppointmentItemModel mItemViewModel;
    @Nullable
    ...
    public ItemAppointmentBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.tvItemAppointmentServerEmployee = (android.widget.TextView) bindings[9];
        this.tvItemAppointmentServerEmployee.setTag(null);
        this.tvItemAppointmentService = (android.widget.TextView) bindings[6];
        this.tvItemAppointmentService.setTag(null);
        this.tvItemAppointmentType = (android.widget.TextView) bindings[7];
        this.tvItemAppointmentType.setTag(null);
        this.tvItemAppointmentVipPhone = (android.widget.TextView) bindings[5];
        this.tvItemAppointmentVipPhone.setTag(null);
        this.tvItemAppointmentWeight = (android.widget.TextView) bindings[8];
        ...
        setRootTag(root);
        // listeners
        mCallback102 = new android.databinding.generated.callback.OnClickListener(this, 1);
        mCallback103 = new android.databinding.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.itemmodel.AppointmentItemModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.itemmodel.AppointmentItemModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.itemmodel.AppointmentItemModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.itemmodel.AppointmentItemModel) object, fieldId);
            case 1 :
    ...
    private boolean onChangeItemViewModel(ys.app.pad.itemmodel.AppointmentItemModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.itemmodel.AppointmentItemModel itemViewModel = mItemViewModel;
        ...
        ys.app.pad.itemmodel.AppointmentBean itemViewModelModel = null;
        ...
        java.lang.String tvItemAppointmentTypeAndroidStringPetNameItemViewModelModelPetName = null;
        ...
        if ((dirtyFlags & 0x3fL) != 0) {
            ...
            if ((dirtyFlags & 0x31L) != 0) {
                    ...
                    // read (@android:string/petName) + (itemViewModel.model.petName)
                    tvItemAppointmentTypeAndroidStringPetNameItemViewModelModelPetName = (tvItemAppointmentType.getResources().getString(R.string.petName)) + (itemViewModelModelPetName);
                    // read AppUtil.getDayTimes(itemViewModel.model.bespeakDay)
                    appUtilGetDayTimesItemViewModelModelBespeakDay = ys.app.pad.utils.AppUtil.getDayTimes(itemViewModelModelBespeakDay);
        ...
        if ((dirtyFlags & 0x20L) != 0) {
            ...
            this.viewAppointmentWaitTime.setOnClickListener(mCallback102);
        }
        if ((dirtyFlags & 0x23L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x31L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.tvItemAppointmentType, tvItemAppointmentTypeAndroidStringPetNameItemViewModelModelPetName);
            android.databinding.adapters.TextViewBindingAdapter.setText(this.tvItemAppointmentVipPhone, itemViewModelModelVipUserPhone);
    ...
    public static ItemAppointmentBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemAppointmentBinding>inflate(inflater, ys.app.pad.R.layout.item_appointment, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemAppointmentBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_appointment, null, false), bindingComponent);
    }
    @NonNull
