...
public class ActivityEditEmployeeBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.manage.EditEmployeeViewModel mViewModel;
    @Nullable
    ...
    private android.databinding.InverseBindingListener editText3androidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.manage.EditEmployeeViewModel viewModel = mViewModel;
    ...
    public ActivityEditEmployeeBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        setRootTag(root);
        // listeners
        mCallback94 = new android.databinding.generated.callback.OnClickListener(this, 2);
        mCallback93 = new android.databinding.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.manage.EditEmployeeViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.manage.EditEmployeeViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.manage.EditEmployeeViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x40L) != 0) {
            ...
            this.selectIv0.setOnClickListener(mCallback94);
        }
        if ((dirtyFlags & 0x61L) != 0) {
            // api target 1
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.manage.EditEmployeeViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.manage.EditEmployeeViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.manage.EditEmployeeViewModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.manage.EditEmployeeViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static ActivityEditEmployeeBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityEditEmployeeBinding>inflate(inflater, ys.app.pad.R.layout.activity_edit_employee, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityEditEmployeeBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_edit_employee, null, false), bindingComponent);
    }
    @NonNull
