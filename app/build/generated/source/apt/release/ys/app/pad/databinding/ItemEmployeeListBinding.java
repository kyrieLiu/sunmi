...
public class ItemEmployeeListBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.manage.EmployeeListItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.viewmodel.manage.EmployeeListItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.viewmodel.manage.EmployeeListItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.manage.EmployeeListItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.viewmodel.manage.EmployeeListItemViewModel) object, fieldId);
            case 1 :
                return onChangeItemViewModelModel((ys.app.pad.model.EmployeeInfo) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItemViewModel(ys.app.pad.viewmodel.manage.EmployeeListItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.manage.EmployeeListItemViewModel itemViewModel = mItemViewModel;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                appUtilGetTimesItemViewModelModelCreateTime = ys.app.pad.utils.AppUtil.getTimes(itemViewModelModelCreateTime);
    ...
    public static ItemEmployeeListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemEmployeeListBinding>inflate(inflater, ys.app.pad.R.layout.item_employee_list, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemEmployeeListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_employee_list, null, false), bindingComponent);
    }
    @NonNull
