...
public class ItemChildOrderBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.OrderChildItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.viewmodel.OrderChildItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.viewmodel.OrderChildItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.OrderChildItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.viewmodel.OrderChildItemViewModel) object, fieldId);
            case 1 :
                return onChangeItemViewModelModel((ys.app.pad.model.OrderInfo.OrderDetailedListBean) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItemViewModel(ys.app.pad.viewmodel.OrderChildItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.OrderChildItemViewModel itemViewModel = mItemViewModel;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setFristPrice(this.mboundView3, itemViewModelModelIsClassification, itemViewModelModelIsPromotion, itemViewModelModelIsFold, itemViewModelModelVipPrice);
            ys.app.pad.utils.PetBindingUtil.setPrice(this.mboundView4, itemViewModelModelIsClassification, itemViewModelModelIsPromotion);
            ...
            ys.app.pad.utils.PetBindingUtil.setCostAndCost(this.mboundView9, itemViewModelModelVipUserId, itemViewModelModelIsPromotion, itemViewModelModelIsFold);
    ...
    public static ItemChildOrderBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemChildOrderBinding>inflate(inflater, ys.app.pad.R.layout.item_child_order, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemChildOrderBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_child_order, null, false), bindingComponent);
    }
    @NonNull
