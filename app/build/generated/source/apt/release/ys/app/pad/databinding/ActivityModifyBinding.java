...
public class ActivityModifyBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    // views
    @NonNull
    public final ys.app.pad.widget.LastInputEditText etCostMoney;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.ModifyViewModel mViewModel;
    @Nullable
    ...
    private android.databinding.InverseBindingListener etCostMoneyandroidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.ModifyViewModel viewModel = mViewModel;
    ...
    public ActivityModifyBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.etCostMoney = (ys.app.pad.widget.LastInputEditText) bindings[8];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.ModifyViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.ModifyViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.ModifyViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 11 :
                return onChangeViewModel((ys.app.pad.viewmodel.ModifyViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.ModifyViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x800L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x1fffL) != 0) {
            ...
            if ((dirtyFlags & 0x1880L) != 0) {
                    ...
                    updateRegistration(7, viewModelObName);
            ...
            if ((dirtyFlags & 0x1900L) != 0) {
                    ...
                    updateRegistration(8, viewModelObUnitName);
            ...
            if ((dirtyFlags & 0x1a00L) != 0) {
                    ...
                    updateRegistration(9, viewModelObStockNum);
            ...
            if ((dirtyFlags & 0x1c00L) != 0) {
                    ...
                    updateRegistration(10, viewModelGetUnitHttpSuccess);
        ...
        if ((dirtyFlags & 0x1800L) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setTextChangedListener(this.etCostMoney, viewModelMChangedListener);
        ...
        if ((dirtyFlags & 0x1000L) != 0) {
            ...
            this.mboundView5.setOnClickListener(mCallback6);
            ...
            this.selectIv.setOnClickListener(mCallback7);
            this.selectIv0.setOnClickListener(mCallback5);
        }
        if ((dirtyFlags & 0x1880L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x1804L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView10, viewModelObRealAmtGet);
        }
        if ((dirtyFlags & 0x1840L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x1802L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView9, viewModelObSeeCostAmtGet);
        }
        if ((dirtyFlags & 0x1c00L) != 0) {
            // api target 1
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.ModifyViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.ModifyViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.ModifyViewModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.ModifyViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static ActivityModifyBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityModifyBinding>inflate(inflater, ys.app.pad.R.layout.activity_modify, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityModifyBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_modify, null, false), bindingComponent);
    }
    @NonNull
    ...
    /* flag mapping
        ...
        flag 7 (0x8L): viewModel.obName
        flag 8 (0x9L): viewModel.obUnitName
        flag 9 (0xaL): viewModel.obStockNum
        flag 10 (0xbL): viewModel.getUnitHttpSuccess
