...
public class ActivityAllAchievementBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.AllAchievementViewModel mViewModel;
    @Nullable
    ...
    private android.databinding.InverseBindingListener mboundView2androidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.AllAchievementViewModel viewModel = mViewModel;
    ...
    public ActivityAllAchievementBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        setRootTag(root);
        // listeners
        mCallback37 = new android.databinding.generated.callback.OnClickListener(this, 1);
        mCallback38 = new android.databinding.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.AllAchievementViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.AllAchievementViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.AllAchievementViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 5 :
                return onChangeViewModel((ys.app.pad.viewmodel.AllAchievementViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.AllAchievementViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x20L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x40L) != 0) {
            ...
            this.mboundView2.setOnClickListener(mCallback37);
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.AllAchievementViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.AllAchievementViewModel value) {
            this.value = value;
    ...
    public static ActivityAllAchievementBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityAllAchievementBinding>inflate(inflater, ys.app.pad.R.layout.activity_all_achievement, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityAllAchievementBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_all_achievement, null, false), bindingComponent);
    }
    @NonNull
