...
public class ActivityAddInventoryBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_6, 10);
    }
    // views
    @NonNull
    ...
    @NonNull
    public final android.widget.LinearLayout ll6;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.AddInventoryViewModel mViewModel;
    @Nullable
    ...
    private android.databinding.InverseBindingListener mboundView3androidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.AddInventoryViewModel viewModel = mViewModel;
            // viewModel != null
    ...
    public ActivityAddInventoryBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.ll6 = (android.widget.LinearLayout) bindings[10];
        ...
        setRootTag(root);
        // listeners
        mCallback39 = new android.databinding.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.AddInventoryViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.AddInventoryViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.AddInventoryViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 4 :
                return onChangeViewModel((ys.app.pad.viewmodel.AddInventoryViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.AddInventoryViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x10L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x90L) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setTextChangedListener(this.mboundView3, viewModelTextChangeListener);
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.AddInventoryViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.AddInventoryViewModel value) {
            this.value = value;
    ...
    public static ActivityAddInventoryBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityAddInventoryBinding>inflate(inflater, ys.app.pad.R.layout.activity_add_inventory, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityAddInventoryBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_add_inventory, null, false), bindingComponent);
    }
    @NonNull
