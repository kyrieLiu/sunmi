...
public class ActivityGoodsDetailBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_goodDetail_vipPrice, 28);
    ...
    @NonNull
    public final android.widget.ImageView ivGoodDetailVipPrice;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.GoodsDetailViewModel mViewModel;
    @Nullable
    ...
    private android.databinding.InverseBindingListener lijianEtandroidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.GoodsDetailViewModel viewModel = mViewModel;
            // viewModel != null
    ...
    public ActivityGoodsDetailBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.iv5 = (android.widget.ImageView) bindings[27];
        this.iv6 = (android.widget.ImageView) bindings[29];
        this.iv7 = (android.widget.ImageView) bindings[30];
        this.ivGoodDetailVipPrice = (android.widget.ImageView) bindings[28];
        ...
        setRootTag(root);
        // listeners
        mCallback30 = new android.databinding.generated.callback.OnClickListener(this, 1);
        mCallback32 = new android.databinding.generated.callback.OnClickListener(this, 3);
        mCallback31 = new android.databinding.generated.callback.OnClickListener(this, 2);
        mCallback35 = new android.databinding.generated.callback.OnClickListener(this, 6);
        mCallback36 = new android.databinding.generated.callback.OnClickListener(this, 7);
        mCallback33 = new android.databinding.generated.callback.OnClickListener(this, 4);
        mCallback34 = new android.databinding.generated.callback.OnClickListener(this, 5);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.GoodsDetailViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.GoodsDetailViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.GoodsDetailViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 6 :
                return onChangeViewModelMResult((ys.app.pad.model.GoodInfo) object, fieldId);
            case 7 :
            ...
            case 12 :
                return onChangeViewModel((ys.app.pad.viewmodel.GoodsDetailViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModelMResult(ys.app.pad.model.GoodInfo ViewModelMResult, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x40L;
            }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.GoodsDetailViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1000L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.model.GoodInfo viewModelMResult = null;
        ...
        java.lang.String appUtilFormatStandardMoneyViewModelMResultVipAmtMboundView8AndroidStringYuan = null;
        int viewModelSelectTypeIdGet = 0;
        double viewModelObSalesAmtGet = 0.0;
        java.lang.String appUtilFormatStandardMoneyViewModelObSalesAmtMboundView7AndroidStringYuan = null;
        java.lang.String viewModelSelectTypeGet = null;
        ...
        if ((dirtyFlags & 0x7ffffL) != 0) {
            ...
            if ((dirtyFlags & 0x41020L) != 0) {
                    ...
                    appUtilFormatStandardMoneyViewModelObSalesAmt = ys.app.pad.utils.AppUtil.formatStandardMoney(viewModelObSalesAmtGet);


                    // read (AppUtil.formatStandardMoney(viewModel.obSalesAmt.get())) + (@android:string/yuan)
                    appUtilFormatStandardMoneyViewModelObSalesAmtMboundView7AndroidStringYuan = (appUtilFormatStandardMoneyViewModelObSalesAmt) + (mboundView7.getResources().getString(R.string.yuan));
            }
            if ((dirtyFlags & 0x7f040L) != 0) {
                ...
                if ((dirtyFlags & 0x51040L) != 0) {
                        ...
                        appUtilFormatStandardMoneyViewModelMResultVipAmtMboundView8AndroidStringYuan = (appUtilFormatStandardMoneyViewModelMResultVipAmt) + (mboundView8.getResources().getString(R.string.yuan));
                }
                if ((dirtyFlags & 0x45040L) != 0) {
        ...
        if ((dirtyFlags & 0x40000L) != 0) {
            ...
            this.img1.setOnClickListener(mCallback35);
            ...
            this.mboundView12.setOnClickListener(mCallback32);
            ...
            this.mboundView17.setOnClickListener(mCallback33);
            ...
            this.mboundView18.setOnClickListener(mCallback34);
            ...
            this.mboundView20.setOnClickListener(mCallback36);
            this.mboundView6.setOnClickListener(mCallback30);
            this.selectIv0.setOnClickListener(mCallback31);
        ...
        if ((dirtyFlags & 0x41020L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView7, appUtilFormatStandardMoneyViewModelObSalesAmtMboundView7AndroidStringYuan);
        }
        if ((dirtyFlags & 0x51040L) != 0) {
            // api target 1

            android.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView8, appUtilFormatStandardMoneyViewModelMResultVipAmtMboundView8AndroidStringYuan);
        }
        if ((dirtyFlags & 0x61040L) != 0) {
            // api target 1
    ...
    public static ActivityGoodsDetailBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityGoodsDetailBinding>inflate(inflater, ys.app.pad.R.layout.activity_goods_detail, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityGoodsDetailBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_goods_detail, null, false), bindingComponent);
    }
    @NonNull
    ...
    /* flag mapping
        ...
        flag 13 (0xeL): viewModel.mResult.name
        flag 14 (0xfL): viewModel.mResult.typeName
        flag 15 (0x10L): viewModel.mResult.unit
        flag 16 (0x11L): viewModel.mResult.vipAmt
