...
public class ItemServiceTypeInVipBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.sign_mao, 3);
        sViewsWithIds.put(R.id.zhe_tv, 4);
    }
    // views
    @NonNull
    public final me.biubiubiu.justifytext.library.JustifyTextView nameTv;
    @NonNull
    public final android.widget.RelativeLayout rootView;
    @NonNull
    public final android.widget.TextView signMao;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.ServiceTypeInVipItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    private android.databinding.InverseBindingListener zhekouTvandroidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // itemViewModel
            ys.app.pad.viewmodel.ServiceTypeInVipItemViewModel itemViewModel = mItemViewModel;
            // itemViewModel != null
    ...
    public ItemServiceTypeInVipBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.nameTv = (me.biubiubiu.justifytext.library.JustifyTextView) bindings[1];
        this.nameTv.setTag(null);
        this.rootView = (android.widget.RelativeLayout) bindings[0];
        this.rootView.setTag(null);
        this.signMao = (android.widget.TextView) bindings[3];
        this.zheTv = (android.widget.TextView) bindings[4];
        this.zhekouTv = (android.widget.EditText) bindings[2];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.viewmodel.ServiceTypeInVipItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.viewmodel.ServiceTypeInVipItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.ServiceTypeInVipItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeItemViewModel((ys.app.pad.viewmodel.ServiceTypeInVipItemViewModel) object, fieldId);
            case 2 :
                return onChangeItemViewModelModel((ys.app.pad.model.ServiceTypeInfo) object, fieldId);
            case 3 :
    ...
    private boolean onChangeItemViewModel(ys.app.pad.viewmodel.ServiceTypeInVipItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    private boolean onChangeItemViewModelModel(ys.app.pad.model.ServiceTypeInfo ItemViewModelModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.ServiceTypeInVipItemViewModel itemViewModel = mItemViewModel;
        java.lang.String itemViewModelObServiceCostGet = null;
        ys.app.pad.model.ServiceTypeInfo itemViewModelModel = null;
        ...
        if ((dirtyFlags & 0x22L) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setTextChangedListener(this.zhekouTv, itemViewModelTextChangeListener);
        }
        if ((dirtyFlags & 0x2aL) != 0) {
            // api target 1

            ys.app.pad.utils.PetBindingUtil.setEditTextEditable(this.zhekouTv, itemViewModelEditTextEditableGet, itemViewModelEditTextEditableGet);
        }
    ...
    public static ItemServiceTypeInVipBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemServiceTypeInVipBinding>inflate(inflater, ys.app.pad.R.layout.item_service_type_in_vip, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemServiceTypeInVipBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_service_type_in_vip, null, false), bindingComponent);
    }
    @NonNull
