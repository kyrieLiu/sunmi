...
public class ActivityEmployeePerformanceBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.manage.EmployeePerformanceViewModel mViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.manage.EmployeePerformanceViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.manage.EmployeePerformanceViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.manage.EmployeePerformanceViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 7 :
                return onChangeViewModel((ys.app.pad.viewmodel.manage.EmployeePerformanceViewModel) object, fieldId);
            case 8 :
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.manage.EmployeePerformanceViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x80L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.manage.EmployeePerformanceViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x3ffL) != 0) {
            ...
            if ((dirtyFlags & 0x3c8L) != 0) {
                ...
                if ((dirtyFlags & 0x288L) != 0) {
                        ...
                        appUtilFormatStandardMoneyViewModelObChargeTotalMoney = ys.app.pad.utils.AppUtil.formatStandardMoney(viewModelObChargeTotalMoneyGet);
                ...
                if ((dirtyFlags & 0x2c0L) != 0) {
                        ...
                        appUtilFormatStandardMoneyViewModelObGoodsTotalMoney = ys.app.pad.utils.AppUtil.formatStandardMoney(viewModelObGoodsTotalMoneyGet);
                ...
                if ((dirtyFlags & 0x380L) != 0) {
                        ...
                        appUtilFormatStandardMoneyViewModelObServiceTotalMoney = ys.app.pad.utils.AppUtil.formatStandardMoney(viewModelObServiceTotalMoneyGet);
                    ...
                    mathUtilAddViewModelObServiceTotalMoneyViewModelObGoodsTotalMoneyViewModelObChargeTotalMoney = ys.app.pad.utils.MathUtil.add(viewModelObServiceTotalMoneyGet, viewModelObGoodsTotalMoneyGet, viewModelObChargeTotalMoneyGet);
                    ...
                    appUtilFormatStandardMoneyMathUtilAddViewModelObServiceTotalMoneyViewModelObGoodsTotalMoneyViewModelObChargeTotalMoney = ys.app.pad.utils.AppUtil.formatStandardMoney(mathUtilAddViewModelObServiceTotalMoneyViewModelObGoodsTotalMoneyViewModelObChargeTotalMoney);
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.manage.EmployeePerformanceViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.manage.EmployeePerformanceViewModel value) {
            this.value = value;
    ...
    public static ActivityEmployeePerformanceBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityEmployeePerformanceBinding>inflate(inflater, ys.app.pad.R.layout.activity_employee_performance, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityEmployeePerformanceBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_employee_performance, null, false), bindingComponent);
    }
    @NonNull
