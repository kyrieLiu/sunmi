...
public class AllotListActivityBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.AllotShopListModel mViewModel;
    @Nullable
    ...
    public AllotListActivityBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.recyclerView = (ys.app.pad.widget.wrapperRecylerView.IRecyclerView) bindings[6];
        this.view = (android.view.View) bindings[5];
        setRootTag(root);
        // listeners
        mCallback74 = new android.databinding.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.AllotShopListModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.AllotShopListModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.AllotShopListModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewModel((ys.app.pad.viewmodel.AllotShopListModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.AllotShopListModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.AllotShopListModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x10L) != 0) {
            ...
            this.okBtn.setOnClickListener(mCallback74);
        }
    }
    // Listener Stub Implementations
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.AllotShopListModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.AllotShopListModel value) {
            this.value = value;
    ...
    @NonNull
    public static AllotListActivityBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static AllotListActivityBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<AllotListActivityBinding>inflate(inflater, ys.app.pad.R.layout.activity_allot_shop_list, root, attachToRoot, bindingComponent);
    }
    @NonNull
    public static AllotListActivityBinding inflate(@NonNull android.view.LayoutInflater inflater) {
        return inflate(inflater, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static AllotListActivityBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_allot_shop_list, null, false), bindingComponent);
    }
    @NonNull
    public static AllotListActivityBinding bind(@NonNull android.view.View view) {
        return bind(view, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static AllotListActivityBinding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        if (!"layout/activity_allot_shop_list_0".equals(view.getTag())) {
            throw new RuntimeException("view tag isn't correct on view:" + view.getTag());
        }
        return new AllotListActivityBinding(bindingComponent, view);
    }
    /* flag mapping
