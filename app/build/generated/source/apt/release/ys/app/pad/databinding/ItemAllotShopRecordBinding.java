...
public class ItemAllotShopRecordBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_allot_type, 8);
        sViewsWithIds.put(R.id.tv_item_allot_record_shopName, 9);
        sViewsWithIds.put(R.id.tv_item_allot_record_isCheck, 10);
    }
    // views
    @NonNull
    ...
    @NonNull
    public final android.widget.ImageView tvItemAllotRecordIsCheck;
    @NonNull
    public final android.widget.TextView tvItemAllotRecordShopName;
    // variables
    @Nullable
    private ys.app.pad.itemmodel.AllotManageRecordItemModel mItemViewModel;
    @Nullable
    ...
    public ItemAllotShopRecordBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.textView15 = (android.widget.TextView) bindings[7];
        this.tvAllotType = (android.widget.TextView) bindings[8];
        this.tvItemAllotRecordIsCheck = (android.widget.ImageView) bindings[10];
        this.tvItemAllotRecordShopName = (android.widget.TextView) bindings[9];
        setRootTag(root);
        // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.itemmodel.AllotManageRecordItemModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.itemmodel.AllotManageRecordItemModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.itemmodel.AllotManageRecordItemModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.itemmodel.AllotManageRecordItemModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItemViewModel(ys.app.pad.itemmodel.AllotManageRecordItemModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.itemmodel.AllotManageRecordItemModel itemViewModel = mItemViewModel;
        ...
        ys.app.pad.model.AllotRecordInfo itemViewModelModel = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                appUtilGetTimesItemViewModelModelDotime = ys.app.pad.utils.AppUtil.getTimes(itemViewModelModelDotime);
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.btItemAllotRecord.setOnClickListener(mCallback100);
        }
        if ((dirtyFlags & 0x7L) != 0) {
            // api target 1
    ...
    public static ItemAllotShopRecordBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemAllotShopRecordBinding>inflate(inflater, ys.app.pad.R.layout.item_allot_manage, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemAllotShopRecordBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_allot_manage, null, false), bindingComponent);
    }
    @NonNull
