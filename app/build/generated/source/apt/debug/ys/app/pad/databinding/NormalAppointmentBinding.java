...
public class NormalAppointmentBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_addGoods_name, 16);
        sViewsWithIds.put(R.id.iv_appointment, 17);
        sViewsWithIds.put(R.id.tv_appointment_time_title, 18);
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.appointment.NormalAppointmentModel mViewModel;
    @Nullable
    ...
    private android.databinding.InverseBindingListener mboundView1androidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.appointment.NormalAppointmentModel viewModel = mViewModel;
            // viewModel != null
    ...
    public NormalAppointmentBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.ivAppointment = (android.widget.ImageView) bindings[17];
        this.ivAppointmentAddPet = (android.widget.ImageView) bindings[5];
        this.ivAppointmentAddPet.setTag(null);
        ...
        this.llAddGoodsName = (android.widget.LinearLayout) bindings[16];
        ...
        this.selectIv = (android.widget.TextView) bindings[11];
        ...
        this.tvAppointmentTimeTitle = (android.widget.TextView) bindings[18];
        setRootTag(root);
        // listeners
        mCallback55 = new android.databinding.generated.callback.OnClickListener(this, 4);
        mCallback56 = new android.databinding.generated.callback.OnClickListener(this, 5);
        mCallback52 = new android.databinding.generated.callback.OnClickListener(this, 1);
        mCallback64 = new android.databinding.generated.callback.OnClickListener(this, 13);
        mCallback54 = new android.databinding.generated.callback.OnClickListener(this, 3);
        mCallback53 = new android.databinding.generated.callback.OnClickListener(this, 2);
        mCallback59 = new android.databinding.generated.callback.OnClickListener(this, 8);
        mCallback62 = new android.databinding.generated.callback.OnClickListener(this, 11);
        mCallback63 = new android.databinding.generated.callback.OnClickListener(this, 12);
        mCallback57 = new android.databinding.generated.callback.OnClickListener(this, 6);
        mCallback60 = new android.databinding.generated.callback.OnClickListener(this, 9);
        mCallback58 = new android.databinding.generated.callback.OnClickListener(this, 7);
        mCallback61 = new android.databinding.generated.callback.OnClickListener(this, 10);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.appointment.NormalAppointmentModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.appointment.NormalAppointmentModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.appointment.NormalAppointmentModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 8 :
                return onChangeViewModel((ys.app.pad.viewmodel.appointment.NormalAppointmentModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.appointment.NormalAppointmentModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x100L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x200L) != 0) {
            ...
            this.ivAppointmentAddPet.setOnClickListener(mCallback54);
            this.ivAppointmentServer.setOnClickListener(mCallback55);
            this.ivAppointmentTime.setOnClickListener(mCallback52);
            ...
            this.mboundView10.setOnClickListener(mCallback59);
            this.mboundView12.setOnClickListener(mCallback61);
            this.mboundView14.setOnClickListener(mCallback63);
    ...
    public static NormalAppointmentBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<NormalAppointmentBinding>inflate(inflater, ys.app.pad.R.layout.fragment_normal_appointment, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static NormalAppointmentBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.fragment_normal_appointment, null, false), bindingComponent);
    }
    @NonNull
