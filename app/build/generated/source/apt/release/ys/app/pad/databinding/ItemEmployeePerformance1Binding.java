...
public class ItemEmployeePerformance1Binding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.manage.EmployeePerformance1ItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.viewmodel.manage.EmployeePerformance1ItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.viewmodel.manage.EmployeePerformance1ItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.manage.EmployeePerformance1ItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.viewmodel.manage.EmployeePerformance1ItemViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItemViewModel(ys.app.pad.viewmodel.manage.EmployeePerformance1ItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.manage.EmployeePerformance1ItemViewModel itemViewModel = mItemViewModel;
        ...
        ys.app.pad.model.EmployeePerformanceInfo.OrderDetailedListCommodityBean itemViewModelModel = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                appUtilFormatStandardMoneyItemViewModelModelCountVipMoney = ys.app.pad.utils.AppUtil.formatStandardMoney(itemViewModelModelCountVipMoney);
                // read DateUtil.longFormatDate3(itemViewModel.model.payDate)
                dateUtilLongFormatDate3ItemViewModelModelPayDate = ys.app.pad.utils.DateUtil.longFormatDate3(itemViewModelModelPayDate);
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setCostAndCost(this.mboundView8, itemViewModelModelVipUserId, itemViewModelModelIsPromotion, itemViewModelModelIsFold);
    ...
    public static ItemEmployeePerformance1Binding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemEmployeePerformance1Binding>inflate(inflater, ys.app.pad.R.layout.item_employee_performance_1, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemEmployeePerformance1Binding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_employee_performance_1, null, false), bindingComponent);
    }
    @NonNull
