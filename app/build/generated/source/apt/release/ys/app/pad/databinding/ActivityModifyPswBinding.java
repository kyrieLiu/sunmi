...
public class ActivityModifyPswBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.manage.ModifyPswViewModel mViewModel;
    // values
    // listeners
    ...
    private android.databinding.InverseBindingListener confirmPswEtandroidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.manage.ModifyPswViewModel viewModel = mViewModel;
            // viewModel != null
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.manage.ModifyPswViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.manage.ModifyPswViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.manage.ModifyPswViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewModel((ys.app.pad.viewmodel.manage.ModifyPswViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.manage.ModifyPswViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.manage.ModifyPswViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.manage.ModifyPswViewModel value) {
            this.value = value;
    ...
    public static ActivityModifyPswBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityModifyPswBinding>inflate(inflater, ys.app.pad.R.layout.activity_modify_psw, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityModifyPswBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_modify_psw, null, false), bindingComponent);
    }
    @NonNull
