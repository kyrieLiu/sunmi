...
public class InventoryRecordsBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.inventory.InventoryRecordsViewModel mViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.inventory.InventoryRecordsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.inventory.InventoryRecordsViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.inventory.InventoryRecordsViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewModel((ys.app.pad.viewmodel.inventory.InventoryRecordsViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.inventory.InventoryRecordsViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.inventory.InventoryRecordsViewModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.inventory.InventoryRecordsViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.inventory.InventoryRecordsViewModel value) {
            this.value = value;
    ...
    public static InventoryRecordsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<InventoryRecordsBinding>inflate(inflater, ys.app.pad.R.layout.activity_inventory_records, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static InventoryRecordsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_inventory_records, null, false), bindingComponent);
    }
    @NonNull
