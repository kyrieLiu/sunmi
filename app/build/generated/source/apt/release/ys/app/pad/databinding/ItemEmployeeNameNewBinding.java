...
public class ItemEmployeeNameNewBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_item_achivement_employee, 2);
    }
    // views
    @NonNull
    public final android.widget.ImageView ivItemAchivementEmployee;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.manage.EmployeeNameNewItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    public ItemEmployeeNameNewBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.ivItemAchivementEmployee = (android.widget.ImageView) bindings[2];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.viewmodel.manage.EmployeeNameNewItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.viewmodel.manage.EmployeeNameNewItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.manage.EmployeeNameNewItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.viewmodel.manage.EmployeeNameNewItemViewModel) object, fieldId);
            case 1 :
                return onChangeItemViewModelModel((ys.app.pad.model.EmployeeInfo) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItemViewModel(ys.app.pad.viewmodel.manage.EmployeeNameNewItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeItemViewModelModel(ys.app.pad.model.EmployeeInfo ItemViewModelModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.manage.EmployeeNameNewItemViewModel itemViewModel = mItemViewModel;
        android.view.View.OnClickListener itemViewModelOnClickButtonAndroidViewViewOnClickListener = null;
        ys.app.pad.model.EmployeeInfo itemViewModelModel = null;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.manage.EmployeeNameNewItemViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.manage.EmployeeNameNewItemViewModel value) {
            this.value = value;
    ...
    public static ItemEmployeeNameNewBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemEmployeeNameNewBinding>inflate(inflater, ys.app.pad.R.layout.item_employee_name_new, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemEmployeeNameNewBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_employee_name_new, null, false), bindingComponent);
    }
    @NonNull
