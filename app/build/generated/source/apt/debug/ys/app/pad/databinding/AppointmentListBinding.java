...
public class AppointmentListBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.appointment.AppointmentListModel mViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.appointment.AppointmentListModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.appointment.AppointmentListModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.appointment.AppointmentListModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewModel((ys.app.pad.viewmodel.appointment.AppointmentListModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.appointment.AppointmentListModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.appointment.AppointmentListModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.appointment.AppointmentListModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.appointment.AppointmentListModel value) {
            this.value = value;
    ...
    public static AppointmentListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<AppointmentListBinding>inflate(inflater, ys.app.pad.R.layout.fragment_appointment_list, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static AppointmentListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.fragment_appointment_list, null, false), bindingComponent);
    }
    @NonNull
