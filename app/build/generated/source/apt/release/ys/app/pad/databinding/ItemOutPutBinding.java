...
public class ItemOutPutBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.itemmodel.OutPutItemModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.itemmodel.OutPutItemModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.itemmodel.OutPutItemModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.itemmodel.OutPutItemModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.itemmodel.OutPutItemModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItemViewModel(ys.app.pad.itemmodel.OutPutItemModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.itemmodel.OutPutItemModel itemViewModel = mItemViewModel;
        ...
        ys.app.pad.model.OutStorageInfo itemViewModelModel = null;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.itemmodel.OutPutItemModel value;
        public OnClickListenerImpl setValue(ys.app.pad.itemmodel.OutPutItemModel value) {
            this.value = value;
    ...
    public static ItemOutPutBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemOutPutBinding>inflate(inflater, ys.app.pad.R.layout.item_out_put_inventory, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemOutPutBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_out_put_inventory, null, false), bindingComponent);
    }
    @NonNull
