...
public class EmployeeServiceBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    @NonNull
    public final android.widget.TextView tvItemShopCarConfirm;
    @NonNull
    ...
    public EmployeeServiceBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.tvItemShopCarConfirm = (android.widget.TextView) bindings[11];
        this.tvItemShopCarConfirm.setTag(null);
        this.typeTv = (android.widget.TextView) bindings[3];
        this.typeTv.setTag(null);
        setRootTag(root);
        // listeners
        mCallback101 = new android.databinding.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeItemViewModelConfirmText((android.databinding.ObservableField<java.lang.String>) object, fieldId);
            case 2 :
    ...
    private boolean onChangeItemViewModelConfirmText(android.databinding.ObservableField<java.lang.String> ItemViewModelConfirmText, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        android.databinding.ObservableField<java.lang.String> itemViewModelConfirmText = null;
        ...
        java.lang.String itemViewModelConfirmTextGet = null;
        ...
        if ((dirtyFlags & 0x1fL) != 0) {
            ...
            if ((dirtyFlags & 0x13L) != 0) {
                    ...
                    if (itemViewModel != null) {
                        // read itemViewModel.confirmText
                        itemViewModelConfirmText = itemViewModel.confirmText;
                    }
                    updateRegistration(1, itemViewModelConfirmText);


                    if (itemViewModelConfirmText != null) {
                        // read itemViewModel.confirmText.get()
                        itemViewModelConfirmTextGet = itemViewModelConfirmText.get();
                    }
            }
            ...
            if ((dirtyFlags & 0x19L) != 0) {
                    ...
                    appUtilFormatStandardMoneyItemViewModelModelPrice = ys.app.pad.utils.AppUtil.formatStandardMoney(itemViewModelModelPrice);
        ...
        if ((dirtyFlags & 0x19L) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setFristPrice(this.mboundView4, itemViewModelModelIsClassification, itemViewModelModelIsPromotion, itemViewModelModelIsFold, itemViewModelModelVipPrice);
            ys.app.pad.utils.PetBindingUtil.setPrice(this.mboundView5, itemViewModelModelIsClassification, itemViewModelModelIsPromotion);
            ...
            ys.app.pad.utils.PetBindingUtil.setCostAndCost(this.tvItemEmployeeDiscount, itemViewModelModelVipUserId, itemViewModelModelIsPromotion, itemViewModelModelIsFold);
        ...
        if ((dirtyFlags & 0x15L) != 0) {
            ...
            this.tvItemShopCarConfirm.setVisibility(itemViewModelSeeDetailViewVISIBLEViewGONE);
        }
        if ((dirtyFlags & 0x10L) != 0) {
            // api target 1

            this.tvItemShopCarConfirm.setOnClickListener(mCallback101);
        }
        if ((dirtyFlags & 0x13L) != 0) {
            // api target 1

            android.databinding.adapters.TextViewBindingAdapter.setText(this.tvItemShopCarConfirm, itemViewModelConfirmTextGet);
        }
    }
    ...
    public static EmployeeServiceBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<EmployeeServiceBinding>inflate(inflater, ys.app.pad.R.layout.item_employee_shop_car_goods, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static EmployeeServiceBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_employee_shop_car_goods, null, false), bindingComponent);
    }
    @NonNull
    ...
    /* flag mapping
        ...
        flag 1 (0x2L): itemViewModel.confirmText
