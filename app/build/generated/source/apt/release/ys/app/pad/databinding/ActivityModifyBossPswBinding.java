...
public class ActivityModifyBossPswBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.manage.ModifyBossPswViewModel mViewModel;
    // values
    // listeners
    ...
    private android.databinding.InverseBindingListener editText2androidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.manage.ModifyBossPswViewModel viewModel = mViewModel;
            // viewModel != null
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.manage.ModifyBossPswViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.manage.ModifyBossPswViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.manage.ModifyBossPswViewModel getViewModel() {
        return mViewModel;
    }
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.manage.ModifyBossPswViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.manage.ModifyBossPswViewModel value) {
            this.value = value;
    ...
    public static ActivityModifyBossPswBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityModifyBossPswBinding>inflate(inflater, ys.app.pad.R.layout.activity_modify_boss_psw, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityModifyBossPswBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_modify_boss_psw, null, false), bindingComponent);
    }
    @NonNull
