...
public class ActivityTakeOutInventoryBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    @NonNull
    public final android.widget.LinearLayout llChukuSelectEmployee;
    @NonNull
    public final android.widget.LinearLayout llChukuSelectShot;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.TakeOutInventoryViewModel mViewModel;
    @Nullable
    ...
    private android.databinding.InverseBindingListener mboundView5androidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.TakeOutInventoryViewModel viewModel = mViewModel;
            // viewModel != null
    ...
    private android.databinding.InverseBindingListener textView12androidTextAttrChanged = new android.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of viewModel.obBackReason.get()
            //         is viewModel.obBackReason.set((java.lang.String) callbackArg_0)
            java.lang.String callbackArg_0 = android.databinding.adapters.TextViewBindingAdapter.getTextString(textView12);
            // localize variables for thread safety
    ...
    public ActivityTakeOutInventoryBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.llChukuSelectEmployee = (android.widget.LinearLayout) bindings[9];
        this.llChukuSelectEmployee.setTag(null);
        this.llChukuSelectShot = (android.widget.LinearLayout) bindings[7];
        this.llChukuSelectShot.setTag(null);
        ...
        this.textView12 = (android.widget.TextView) bindings[6];
        ...
        setRootTag(root);
        // listeners
        mCallback98 = new android.databinding.generated.callback.OnClickListener(this, 2);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.TakeOutInventoryViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.TakeOutInventoryViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.TakeOutInventoryViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x10a0L) != 0) {
            ...
            this.llChukuSelectEmployee.setVisibility(viewModelAllotVisibleViewVISIBLEViewGONE);
            this.llChukuSelectShot.setVisibility(viewModelAllotVisibleViewVISIBLEViewGONE);
        }
        if ((dirtyFlags & 0x1188L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x1080L) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setTextChangedListener(this.mboundView5, viewModelTextChangeListener);
            this.textView12.setOnClickListener(viewModelClickSelectButtonAndroidViewViewOnClickListener);
        }
        if ((dirtyFlags & 0x1288L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x1000L) != 0) {
            ...
            this.mboundView8.setOnClickListener(mCallback97);
            android.databinding.adapters.TextViewBindingAdapter.setTextWatcher(this.textView12, (android.databinding.adapters.TextViewBindingAdapter.BeforeTextChanged)null, (android.databinding.adapters.TextViewBindingAdapter.OnTextChanged)null, (android.databinding.adapters.TextViewBindingAdapter.AfterTextChanged)null, textView12androidTextAttrChanged);
            this.textView16.setOnClickListener(mCallback98);
        }
        if ((dirtyFlags & 0x1084L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x10c0L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.textView12, viewModelObBackReasonGet);
        }
        if ((dirtyFlags & 0x1090L) != 0) {
            // api target 1
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.TakeOutInventoryViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.TakeOutInventoryViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.TakeOutInventoryViewModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.TakeOutInventoryViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static ActivityTakeOutInventoryBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityTakeOutInventoryBinding>inflate(inflater, ys.app.pad.R.layout.activity_take_out_inventory, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityTakeOutInventoryBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_take_out_inventory, null, false), bindingComponent);
    }
    @NonNull
