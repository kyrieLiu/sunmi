...
public class SandQRCodeBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_scan_warn, 4);
        sViewsWithIds.put(R.id.tv_personal_pay, 5);
        sViewsWithIds.put(R.id.iv_QR_code_weixin, 6);
    }
    // views
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.SandQRCodeModel mViewModel;
    // values
    // listeners
    ...
    public SandQRCodeBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.ivQRCodeWeixin = (android.widget.ImageView) bindings[6];
        ...
        this.tvScanWarn = (android.widget.TextView) bindings[4];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.SandQRCodeModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.SandQRCodeModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.SandQRCodeModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 2 :
                return onChangeViewModel((ys.app.pad.viewmodel.SandQRCodeModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.SandQRCodeModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.SandQRCodeModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.SandQRCodeModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.SandQRCodeModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.SandQRCodeModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.SandQRCodeModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static SandQRCodeBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<SandQRCodeBinding>inflate(inflater, ys.app.pad.R.layout.activity_sand_qrcode, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static SandQRCodeBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_sand_qrcode, null, false), bindingComponent);
    }
    @NonNull
