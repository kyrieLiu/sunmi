...
public class ItemSearchServiceBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.SearchServiceItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.viewmodel.SearchServiceItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.viewmodel.SearchServiceItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.SearchServiceItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.viewmodel.SearchServiceItemViewModel) object, fieldId);
            case 1 :
    ...
    private boolean onChangeItemViewModel(ys.app.pad.viewmodel.SearchServiceItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.SearchServiceItemViewModel itemViewModel = mItemViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.SearchServiceItemViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.SearchServiceItemViewModel value) {
            this.value = value;
    ...
    public static ItemSearchServiceBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemSearchServiceBinding>inflate(inflater, ys.app.pad.R.layout.item_search_service, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemSearchServiceBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_search_service, null, false), bindingComponent);
    }
    @NonNull
