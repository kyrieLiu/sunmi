...
public class OutStorageDetialBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.model.OutStorageInfo mDataBean;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.dataBean == variableId) {
            setDataBean((ys.app.pad.model.OutStorageInfo) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setDataBean(@Nullable ys.app.pad.model.OutStorageInfo DataBean) {
    ...
    @Nullable
    public ys.app.pad.model.OutStorageInfo getDataBean() {
        return mDataBean;
    }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.model.OutStorageInfo dataBean = mDataBean;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                textUtilIsEmptyDataBeanReasons = ys.app.pad.widget.timeselector.Utils.TextUtil.isEmpty(dataBeanReasons);
                ...
                dateUtilLongFormatDate2DataBeanDotime = ys.app.pad.utils.DateUtil.longFormatDate2(dataBeanDotime);
    ...
    public static OutStorageDetialBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<OutStorageDetialBinding>inflate(inflater, ys.app.pad.R.layout.activity_out_storage_detail, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static OutStorageDetialBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_out_storage_detail, null, false), bindingComponent);
    }
    @NonNull
