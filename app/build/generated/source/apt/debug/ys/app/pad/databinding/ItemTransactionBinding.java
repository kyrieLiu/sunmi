...
public class ItemTransactionBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.ItemTransactionViewModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.viewmodel.ItemTransactionViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.viewmodel.ItemTransactionViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.ItemTransactionViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.viewmodel.ItemTransactionViewModel) object, fieldId);
            case 1 :
    ...
    private boolean onChangeItemViewModel(ys.app.pad.viewmodel.ItemTransactionViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.ItemTransactionViewModel itemViewModel = mItemViewModel;
        ...
        if ((dirtyFlags & 0x3fL) != 0) {
            ...
            if ((dirtyFlags & 0x25L) != 0) {
                    ...
                    appUtilGetTimesItemViewModelModelOrderTime = ys.app.pad.utils.AppUtil.getTimes(itemViewModelModelOrderTime);
            }
    ...
    public static ItemTransactionBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemTransactionBinding>inflate(inflater, ys.app.pad.R.layout.item_transaction, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemTransactionBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_transaction, null, false), bindingComponent);
    }
    @NonNull
