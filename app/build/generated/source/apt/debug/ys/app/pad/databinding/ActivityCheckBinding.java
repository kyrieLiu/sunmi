...
public class ActivityCheckBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.CheckViewModel mViewModel;
    // values
    // listeners
    ...
    public ActivityCheckBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.recyclerView = (ys.app.pad.widget.wrapperRecylerView.IRecyclerView) bindings[8];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.CheckViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.CheckViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.CheckViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 4 :
                return onChangeViewModel((ys.app.pad.viewmodel.CheckViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.CheckViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x10L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.CheckViewModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.CheckViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.CheckViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.CheckViewModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.CheckViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static ActivityCheckBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityCheckBinding>inflate(inflater, ys.app.pad.R.layout.activity_check, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityCheckBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_check, null, false), bindingComponent);
    }
    @NonNull
