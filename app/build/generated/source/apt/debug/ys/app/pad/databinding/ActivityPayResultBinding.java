...
public class ActivityPayResultBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rmb0, 15);
        sViewsWithIds.put(R.id.rmb, 16);
    ...
    @NonNull
    public final android.widget.TextView rmb;
    @NonNull
    public final android.widget.TextView rmb0;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.vip.PayResultViewModel mViewModel;
    // values
    // listeners
    ...
    public ActivityPayResultBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.rmb = (android.widget.TextView) bindings[16];
        this.rmb0 = (android.widget.TextView) bindings[15];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.vip.PayResultViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.vip.PayResultViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.vip.PayResultViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 8 :
                return onChangeViewModel((ys.app.pad.viewmodel.vip.PayResultViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.vip.PayResultViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x100L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.vip.PayResultViewModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.PayResultViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.vip.PayResultViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.PayResultViewModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.vip.PayResultViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl2 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.PayResultViewModel value;
        public OnClickListenerImpl2 setValue(ys.app.pad.viewmodel.vip.PayResultViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static ActivityPayResultBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityPayResultBinding>inflate(inflater, ys.app.pad.R.layout.activity_pay_result, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityPayResultBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_pay_result, null, false), bindingComponent);
    }
    @NonNull
