...
public class ActivityAddServiceBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_add_goods_vipPrice, 15);
    }
    // views
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.AddServiceActivityViewModel mViewModel;
    @Nullable
    ...
    private android.databinding.InverseBindingListener mboundView1androidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.AddServiceActivityViewModel viewModel = mViewModel;
    ...
    public ActivityAddServiceBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.llAddGoodsVipPrice = (android.widget.LinearLayout) bindings[15];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.AddServiceActivityViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.AddServiceActivityViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.AddServiceActivityViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 6 :
                return onChangeViewModel((ys.app.pad.viewmodel.AddServiceActivityViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.AddServiceActivityViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x40L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0xc0L) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setTextChangedListener(this.mboundView4, viewModelChangedListener);
        ...
        if ((dirtyFlags & 0xc1L) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setImgData(this.mboundView6, viewModelImgDataGet);
        }
        if ((dirtyFlags & 0xc2L) != 0) {
            // api target 1
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.AddServiceActivityViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.AddServiceActivityViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.AddServiceActivityViewModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.AddServiceActivityViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static ActivityAddServiceBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityAddServiceBinding>inflate(inflater, ys.app.pad.R.layout.activity_add_service, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityAddServiceBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_add_service, null, false), bindingComponent);
    }
    @NonNull
