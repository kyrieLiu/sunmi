...
public class VipPetListBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    // variables
    @Nullable
    private ys.app.pad.itemmodel.VipPetItemViewModel mItemViewModel;
    @Nullable
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.itemmodel.VipPetItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.itemmodel.VipPetItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.itemmodel.VipPetItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeItemViewModel((ys.app.pad.itemmodel.VipPetItemViewModel) object, fieldId);
            case 2 :
    ...
    private boolean onChangeItemViewModel(ys.app.pad.itemmodel.VipPetItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.itemmodel.VipPetItemViewModel itemViewModel = mItemViewModel;
        java.lang.String itemViewModelVipNameGet = null;
        ys.app.pad.model.VipInfo itemViewModelModel = null;
        java.util.List<ys.app.pad.model.AnimalInfo> itemViewModelModelPetList = null;
        ...
        if ((dirtyFlags & 0xeL) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setVipPetAdapterData(this.mboundView4, itemViewModelModelPetList);
        }
        if ((dirtyFlags & 0xbL) != 0) {
            // api target 1
    ...
    public static VipPetListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<VipPetListBinding>inflate(inflater, ys.app.pad.R.layout.item_vip_pet_list, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static VipPetListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_vip_pet_list, null, false), bindingComponent);
    }
    @NonNull
