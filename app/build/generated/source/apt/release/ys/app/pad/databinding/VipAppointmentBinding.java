...
public class VipAppointmentBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    @NonNull
    public final android.widget.TextView textView18;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.appointment.VipAppointmentModel mViewModel;
    @Nullable
    ...
    public VipAppointmentBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.textView18 = (android.widget.TextView) bindings[5];
        ...
        setRootTag(root);
        // listeners
        mCallback79 = new android.databinding.generated.callback.OnClickListener(this, 5);
        mCallback82 = new android.databinding.generated.callback.OnClickListener(this, 8);
        mCallback83 = new android.databinding.generated.callback.OnClickListener(this, 9);
        mCallback77 = new android.databinding.generated.callback.OnClickListener(this, 3);
        mCallback80 = new android.databinding.generated.callback.OnClickListener(this, 6);
        mCallback78 = new android.databinding.generated.callback.OnClickListener(this, 4);
        mCallback81 = new android.databinding.generated.callback.OnClickListener(this, 7);
        mCallback86 = new android.databinding.generated.callback.OnClickListener(this, 12);
        mCallback76 = new android.databinding.generated.callback.OnClickListener(this, 2);
        mCallback75 = new android.databinding.generated.callback.OnClickListener(this, 1);
        mCallback84 = new android.databinding.generated.callback.OnClickListener(this, 10);
        mCallback85 = new android.databinding.generated.callback.OnClickListener(this, 11);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.appointment.VipAppointmentModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.appointment.VipAppointmentModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.appointment.VipAppointmentModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 9 :
                return onChangeViewModel((ys.app.pad.viewmodel.appointment.VipAppointmentModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.appointment.VipAppointmentModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x200L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.appointment.VipAppointmentModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x400L) != 0) {
            ...
            this.ivAppointmentEnd.setOnClickListener(mCallback75);
            this.ivAppointmentServer.setOnClickListener(mCallback77);
            this.ivAppointmentTime.setOnClickListener(mCallback82);
            this.ivAppointmentTimeDay.setOnClickListener(mCallback84);
            this.mboundView10.setOnClickListener(mCallback81);
            this.mboundView12.setOnClickListener(mCallback83);
            this.mboundView14.setOnClickListener(mCallback85);
            this.mboundView15.setOnClickListener(mCallback86);
            this.mboundView7.setOnClickListener(mCallback78);
            this.mboundView8.setOnClickListener(mCallback79);
            this.textView18.setOnClickListener(mCallback76);
            this.tvAppointmentEmployee.setOnClickListener(mCallback80);
        }
        if ((dirtyFlags & 0x620L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x610L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.textView18, viewModelPetNameGet);
        }
    }
    ...
    public static VipAppointmentBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<VipAppointmentBinding>inflate(inflater, ys.app.pad.R.layout.fragment_vip_appointment, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static VipAppointmentBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.fragment_vip_appointment, null, false), bindingComponent);
    }
    @NonNull
