...
public class PersonalPayBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_personal_pay_warn, 5);
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.PersonalPayModel mViewModel;
    // values
    // listeners
    ...
    public PersonalPayBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.tvPersonalPayWarn = (android.widget.TextView) bindings[5];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.PersonalPayModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.PersonalPayModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.PersonalPayModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 2 :
                return onChangeViewModel((ys.app.pad.viewmodel.PersonalPayModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.PersonalPayModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.PersonalPayModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.PersonalPayModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.PersonalPayModel value) {
            this.value = value;
    ...
    public static PersonalPayBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<PersonalPayBinding>inflate(inflater, ys.app.pad.R.layout.activity_personal_pay, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static PersonalPayBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_personal_pay, null, false), bindingComponent);
    }
    @NonNull
