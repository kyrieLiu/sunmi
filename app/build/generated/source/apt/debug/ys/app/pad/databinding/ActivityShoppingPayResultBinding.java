...
public class ActivityShoppingPayResultBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.up_ll, 11);
        sViewsWithIds.put(R.id.rl_shopping_pay_money, 12);
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.ShoppingPayResultViewModel mViewModel;
    // values
    // listeners
    ...
    public ActivityShoppingPayResultBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.rlShoppingPayMoney = (android.widget.RelativeLayout) bindings[12];
        this.upLl = (android.widget.LinearLayout) bindings[11];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.ShoppingPayResultViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.ShoppingPayResultViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.ShoppingPayResultViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 6 :
                return onChangeViewModel((ys.app.pad.viewmodel.ShoppingPayResultViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.ShoppingPayResultViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x40L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.ShoppingPayResultViewModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.ShoppingPayResultViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.ShoppingPayResultViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.ShoppingPayResultViewModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.ShoppingPayResultViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl2 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.ShoppingPayResultViewModel value;
        public OnClickListenerImpl2 setValue(ys.app.pad.viewmodel.ShoppingPayResultViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static ActivityShoppingPayResultBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityShoppingPayResultBinding>inflate(inflater, ys.app.pad.R.layout.activity_shopping_pay_result, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityShoppingPayResultBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_shopping_pay_result, null, false), bindingComponent);
    }
    @NonNull
