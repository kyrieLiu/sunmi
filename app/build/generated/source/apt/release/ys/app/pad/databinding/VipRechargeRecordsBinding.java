...
public class VipRechargeRecordsBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.vip.VipRechargeRecordsViewModel mViewModel;
    // values
    // listeners
    private OnClickListenerImpl mViewModelOnClickNetWorkErrorAndroidViewViewOnClickListener;
    // Inverse Binding Event Handlers

    public VipRechargeRecordsBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.recyclerView = (ys.app.pad.widget.wrapperRecylerView.IRecyclerView) bindings[4];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.vip.VipRechargeRecordsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.vip.VipRechargeRecordsViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.vip.VipRechargeRecordsViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewModel((ys.app.pad.viewmodel.vip.VipRechargeRecordsViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.vip.VipRechargeRecordsViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.vip.VipRechargeRecordsViewModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.VipRechargeRecordsViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.vip.VipRechargeRecordsViewModel value) {
            this.value = value;
    ...
    @NonNull
    public static VipRechargeRecordsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static VipRechargeRecordsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<VipRechargeRecordsBinding>inflate(inflater, ys.app.pad.R.layout.fragment_vip_recharge, root, attachToRoot, bindingComponent);
    }
    @NonNull
    public static VipRechargeRecordsBinding inflate(@NonNull android.view.LayoutInflater inflater) {
        return inflate(inflater, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static VipRechargeRecordsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.fragment_vip_recharge, null, false), bindingComponent);
    }
    @NonNull
    public static VipRechargeRecordsBinding bind(@NonNull android.view.View view) {
        return bind(view, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static VipRechargeRecordsBinding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        if (!"layout/fragment_vip_recharge_0".equals(view.getTag())) {
            throw new RuntimeException("view tag isn't correct on view:" + view.getTag());
        }
        return new VipRechargeRecordsBinding(bindingComponent, view);
    }
    /* flag mapping
