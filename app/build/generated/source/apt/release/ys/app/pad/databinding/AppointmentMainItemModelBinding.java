...
public class AppointmentMainItemModelBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.itemmodel.AppointmentMainItemModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.itemmodel.AppointmentMainItemModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.itemmodel.AppointmentMainItemModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.itemmodel.AppointmentMainItemModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.itemmodel.AppointmentMainItemModel) object, fieldId);
            case 1 :
    ...
    private boolean onChangeItemViewModel(ys.app.pad.itemmodel.AppointmentMainItemModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.itemmodel.AppointmentMainItemModel itemViewModel = mItemViewModel;
        ...
        ys.app.pad.model.AppointmentMainBean itemViewModelModel = null;
    ...
    public static AppointmentMainItemModelBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<AppointmentMainItemModelBinding>inflate(inflater, ys.app.pad.R.layout.item_appointment_main, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static AppointmentMainItemModelBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_appointment_main, null, false), bindingComponent);
    }
    @NonNull
