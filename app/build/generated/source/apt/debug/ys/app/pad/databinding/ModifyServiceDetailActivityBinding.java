...
public class ModifyServiceDetailActivityBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_add_goods_vipPrice, 11);
    }
    // views
    @NonNull
    ...
    @NonNull
    private final ys.app.pad.widget.ContainsEmojiEditText mboundView1;
    @NonNull
    private final android.widget.TextView mboundView3;
    @NonNull
    private final ys.app.pad.widget.LastInputEditText mboundView4;
    @NonNull
    private final ys.app.pad.widget.LastInputEditText mboundView5;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.ModifyServiceDetailViewModel mViewModel;
    @Nullable
    ...
    public ModifyServiceDetailActivityBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.llAddGoodsVipPrice = (android.widget.LinearLayout) bindings[11];
        this.mboundView0 = (android.widget.RelativeLayout) bindings[0];
        this.mboundView0.setTag(null);
        this.mboundView1 = (ys.app.pad.widget.ContainsEmojiEditText) bindings[1];
        this.mboundView1.setTag(null);
        this.mboundView3 = (android.widget.TextView) bindings[3];
        this.mboundView3.setTag(null);
        this.mboundView4 = (ys.app.pad.widget.LastInputEditText) bindings[4];
        this.mboundView4.setTag(null);
        this.mboundView5 = (ys.app.pad.widget.LastInputEditText) bindings[5];
        ...
        setRootTag(root);
        // listeners
        mCallback68 = new android.databinding.generated.callback.OnClickListener(this, 1);
        mCallback69 = new android.databinding.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.ModifyServiceDetailViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.ModifyServiceDetailViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.ModifyServiceDetailViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 5 :
                return onChangeViewModel((ys.app.pad.viewmodel.ModifyServiceDetailViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.ModifyServiceDetailViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x20L;
            }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x7fL) != 0) {
            ...
            if ((dirtyFlags & 0x68L) != 0) {
                    ...
                    updateRegistration(3, viewModelObServiceVipPrice);
        ...
        if ((dirtyFlags & 0x40L) != 0) {
            ...
            this.mboundView3.setOnClickListener(mCallback69);
            ...
            this.selectIv0.setOnClickListener(mCallback68);
        }
        if ((dirtyFlags & 0x64L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x60L) != 0) {
            ...
            ys.app.pad.utils.PetBindingUtil.setTextChangedListener(this.mboundView4, viewModelMTCredTSChangedListener);
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.ModifyServiceDetailViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.ModifyServiceDetailViewModel value) {
            this.value = value;
    ...
    public static ModifyServiceDetailActivityBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ModifyServiceDetailActivityBinding>inflate(inflater, ys.app.pad.R.layout.activity_modify_service, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ModifyServiceDetailActivityBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_modify_service, null, false), bindingComponent);
    }
    @NonNull
    ...
    /* flag mapping
        ...
        flag 3 (0x4L): viewModel.obServiceVipPrice
