...
public class ItemEmployeePerformance3Binding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.manage.EmployeePerformance3ItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.viewmodel.manage.EmployeePerformance3ItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.viewmodel.manage.EmployeePerformance3ItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.manage.EmployeePerformance3ItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.viewmodel.manage.EmployeePerformance3ItemViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItemViewModel(ys.app.pad.viewmodel.manage.EmployeePerformance3ItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.manage.EmployeePerformance3ItemViewModel itemViewModel = mItemViewModel;
        ...
        ys.app.pad.model.EmployeePerformanceInfo.RechargeListBean itemViewModelModel = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView3, dateUtilLongFormatDate3ItemViewModelModelPayDate);
    ...
    public static ItemEmployeePerformance3Binding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemEmployeePerformance3Binding>inflate(inflater, ys.app.pad.R.layout.item_employee_performance_3, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemEmployeePerformance3Binding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_employee_performance_3, null, false), bindingComponent);
    }
    @NonNull
