...
public class ActivityGoodsBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_collectMoney_goods, 6);
        sViewsWithIds.put(R.id.rl_collectMoney_goods_top, 7);
        sViewsWithIds.put(R.id.tv_collect_money_goods, 8);
        sViewsWithIds.put(R.id.iv_arrow_service, 9);
        sViewsWithIds.put(R.id.rv_collectMoney_trade, 10);
    ...
    @NonNull
    public final android.widget.ImageView ivArrowService;
    @Nullable
    public final android.view.View layoutHead;
    @NonNull
    public final android.widget.LinearLayout llCollectMoneyGoods;
    @NonNull
    ...
    @NonNull
    public final android.widget.RelativeLayout rlCollectMoneyGoodsTop;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.GoodsActivityViewModel mViewModel;
    // values
    // listeners
    private OnClickListenerImpl mViewModelOnClickNetWorkErrorAndroidViewViewOnClickListener;
    // Inverse Binding Event Handlers

    public ActivityGoodsBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.ivArrowService = (android.widget.ImageView) bindings[9];
        this.layoutHead = (android.view.View) bindings[5];
        this.llCollectMoneyGoods = (android.widget.LinearLayout) bindings[6];
        ...
        this.recyclerView = (ys.app.pad.widget.wrapperRecylerView.IRecyclerView) bindings[11];
        this.rlCollectMoneyGoodsTop = (android.widget.RelativeLayout) bindings[7];
        this.rvCollectMoneyTrade = (android.support.v7.widget.RecyclerView) bindings[10];
        this.tvCollectMoneyGoods = (android.widget.TextView) bindings[8];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.GoodsActivityViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.GoodsActivityViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.GoodsActivityViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewModel((ys.app.pad.viewmodel.GoodsActivityViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.GoodsActivityViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.GoodsActivityViewModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.GoodsActivityViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.GoodsActivityViewModel value) {
            this.value = value;
    ...
    @NonNull
    public static ActivityGoodsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static ActivityGoodsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityGoodsBinding>inflate(inflater, ys.app.pad.R.layout.activity_goods, root, attachToRoot, bindingComponent);
    }
    @NonNull
    public static ActivityGoodsBinding inflate(@NonNull android.view.LayoutInflater inflater) {
        return inflate(inflater, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static ActivityGoodsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_goods, null, false), bindingComponent);
    }
    @NonNull
    public static ActivityGoodsBinding bind(@NonNull android.view.View view) {
        return bind(view, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static ActivityGoodsBinding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        if (!"layout/activity_goods_0".equals(view.getTag())) {
            throw new RuntimeException("view tag isn't correct on view:" + view.getTag());
        }
        return new ActivityGoodsBinding(bindingComponent, view);
    }
    /* flag mapping
