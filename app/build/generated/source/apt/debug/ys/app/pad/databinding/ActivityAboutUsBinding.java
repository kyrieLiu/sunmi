...
public class ActivityAboutUsBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.manage.AboutUsViewModel mViewModel;
    @Nullable
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.manage.AboutUsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.manage.AboutUsViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.manage.AboutUsViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.manage.AboutUsViewModel viewModel = mViewModel;
    ...
    public static ActivityAboutUsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityAboutUsBinding>inflate(inflater, ys.app.pad.R.layout.activity_about_us, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityAboutUsBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_about_us, null, false), bindingComponent);
    }
    @NonNull
