...
public class ItemNumCardBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.zhe_tv, 1);
        sViewsWithIds.put(R.id.et_item_num_card_number, 2);
        sViewsWithIds.put(R.id.tv_item_num_card_name, 3);
        sViewsWithIds.put(R.id.tv_item_maohao, 4);
    }
    // views
    @NonNull
    ...
    @NonNull
    public final android.widget.TextView tvItemMaohao;
    @NonNull
    ...
    public ItemNumCardBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.etItemNumCardNumber = (android.widget.EditText) bindings[2];
        this.rootView = (android.widget.RelativeLayout) bindings[0];
        this.rootView.setTag(null);
        this.tvItemMaohao = (android.widget.TextView) bindings[4];
        this.tvItemNumCardName = (android.widget.TextView) bindings[3];
        this.zheTv = (android.widget.TextView) bindings[1];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public static ItemNumCardBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemNumCardBinding>inflate(inflater, ys.app.pad.R.layout.item_num_card_service, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemNumCardBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_num_card_service, null, false), bindingComponent);
    }
    @NonNull
