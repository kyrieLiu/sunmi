...
public class ActivityPayBinding extends android.databinding.ViewDataBinding  {
    ...
    // views
    @NonNull
    public final android.widget.Button btPay;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.vip.PayViewModel mViewModel;
    // values
    // listeners
    ...
    private OnClickListenerImpl4 mViewModelClickXinhangkaPayAndroidViewViewOnClickListener;
    private OnClickListenerImpl5 mViewModelClickXianjinPayAndroidViewViewOnClickListener;
    private OnClickListenerImpl6 mViewModelClickWeixinPayAndroidViewViewOnClickListener;
    private OnClickListenerImpl7 mViewModelClickWeixinScannerPayAndroidViewViewOnClickListener;
    private OnClickListenerImpl8 mViewModelClickBossWeixinAndroidViewViewOnClickListener;
    ...
    public ActivityPayBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.btPay = (android.widget.Button) bindings[1];
        this.btPay.setTag(null);
        this.iv0 = (android.widget.ImageView) bindings[18];
        this.iv1 = (android.widget.ImageView) bindings[20];
        this.iv2 = (android.widget.ImageView) bindings[21];
        ...
        this.textView3 = (android.widget.TextView) bindings[19];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.vip.PayViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.vip.PayViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.vip.PayViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModelMChargeInfo((ys.app.pad.model.ChargeInfo) object, fieldId);
            case 1 :
            ...
            case 4 :
                return onChangeViewModel((ys.app.pad.viewmodel.vip.PayViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewModelMChargeInfo(ys.app.pad.model.ChargeInfo ViewModelMChargeInfo, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.vip.PayViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x10L;
            }
    ...
    protected void executeBindings() {
        ...
        android.graphics.drawable.Drawable viewModelPayTypeInt2MboundView13AndroidDrawableXuanzhongMboundView13AndroidDrawableShapeLoginInput = null;
        ...
        ys.app.pad.model.ChargeInfo viewModelMChargeInfo = null;
        ...
        android.graphics.drawable.Drawable viewModelPayTypeInt6MboundView15AndroidDrawableXuanzhongMboundView15AndroidDrawableShapeLoginInput = null;
        ...
        android.graphics.drawable.Drawable viewModelPayTypeInt3MboundView14AndroidDrawableXuanzhongMboundView14AndroidDrawableShapeLoginInput = null;
        ...
        android.graphics.drawable.Drawable viewModelPayTypeInt5MboundView12AndroidDrawableXuanzhongMboundView12AndroidDrawableShapeLoginInput = null;
        android.graphics.drawable.Drawable viewModelPayTypeInt4MboundView11AndroidDrawableXuanzhongMboundView11AndroidDrawableShapeLoginInput = null;
        ...
        android.graphics.drawable.Drawable viewModelPayTypeInt7MboundView16AndroidDrawableXuanzhongMboundView16AndroidDrawableShapeLoginInput = null;
        android.databinding.ObservableInt viewModelPayType = null;
        boolean viewModelPayTypeInt0 = false;
        ys.app.pad.viewmodel.vip.PayViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x3fL) != 0) {
            ...
            if ((dirtyFlags & 0x30L) != 0) {
                    ...
                    if (viewModel != null) {
                        ...
                        viewModelClickXinhangkaPayAndroidViewViewOnClickListener = (((mViewModelClickXinhangkaPayAndroidViewViewOnClickListener == null) ? (mViewModelClickXinhangkaPayAndroidViewViewOnClickListener = new OnClickListenerImpl4()) : mViewModelClickXinhangkaPayAndroidViewViewOnClickListener).setValue(viewModel));
                        // read viewModel::clickXianjinPay
                        viewModelClickXianjinPayAndroidViewViewOnClickListener = (((mViewModelClickXianjinPayAndroidViewViewOnClickListener == null) ? (mViewModelClickXianjinPayAndroidViewViewOnClickListener = new OnClickListenerImpl5()) : mViewModelClickXianjinPayAndroidViewViewOnClickListener).setValue(viewModel));
                        // read viewModel::clickWeixinPay
                        viewModelClickWeixinPayAndroidViewViewOnClickListener = (((mViewModelClickWeixinPayAndroidViewViewOnClickListener == null) ? (mViewModelClickWeixinPayAndroidViewViewOnClickListener = new OnClickListenerImpl6()) : mViewModelClickWeixinPayAndroidViewViewOnClickListener).setValue(viewModel));
                        // read viewModel::clickWeixinScannerPay
                        viewModelClickWeixinScannerPayAndroidViewViewOnClickListener = (((mViewModelClickWeixinScannerPayAndroidViewViewOnClickListener == null) ? (mViewModelClickWeixinScannerPayAndroidViewViewOnClickListener = new OnClickListenerImpl7()) : mViewModelClickWeixinScannerPayAndroidViewViewOnClickListener).setValue(viewModel));
                        // read viewModel::clickBossWeixin
                        viewModelClickBossWeixinAndroidViewViewOnClickListener = (((mViewModelClickBossWeixinAndroidViewViewOnClickListener == null) ? (mViewModelClickBossWeixinAndroidViewViewOnClickListener = new OnClickListenerImpl8()) : mViewModelClickBossWeixinAndroidViewViewOnClickListener).setValue(viewModel));
                    }
            }
            if ((dirtyFlags & 0x31L) != 0) {
                    ...
                    appUtilFormatStandardMoneyViewModelMChargeInfoChargeMoney = ys.app.pad.utils.AppUtil.formatStandardMoney(viewModelMChargeInfoChargeMoney);
                    // read AppUtil.formatStandardMoney(viewModel.mChargeInfo.money)
                    appUtilFormatStandardMoneyViewModelMChargeInfoMoney = ys.app.pad.utils.AppUtil.formatStandardMoney(viewModelMChargeInfoMoney);
                    // read AppUtil.formatStandardMoney(viewModel.mChargeInfo.presentAmt)
                    appUtilFormatStandardMoneyViewModelMChargeInfoPresentAmt = ys.app.pad.utils.AppUtil.formatStandardMoney(viewModelMChargeInfoPresentAmt);
            ...
            if ((dirtyFlags & 0x38L) != 0) {
                ...
                if((dirtyFlags & 0x38L) != 0) {
                    ...
                    viewModelPayTypeInt4MboundView11AndroidDrawableXuanzhongMboundView11AndroidDrawableShapeLoginInput = ((viewModelPayTypeInt4) ? (getDrawableFromResource(mboundView11, R.drawable.xuanzhong)) : (getDrawableFromResource(mboundView11, R.drawable.shape_login_input)));
                    ...
                    viewModelPayTypeInt7MboundView16AndroidDrawableXuanzhongMboundView16AndroidDrawableShapeLoginInput = ((viewModelPayTypeInt7) ? (getDrawableFromResource(mboundView16, R.drawable.xuanzhong)) : (getDrawableFromResource(mboundView16, R.drawable.shape_login_input)));
                    // read viewModel.payType.get() == 6 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
                    viewModelPayTypeInt6MboundView15AndroidDrawableXuanzhongMboundView15AndroidDrawableShapeLoginInput = ((viewModelPayTypeInt6) ? (getDrawableFromResource(mboundView15, R.drawable.xuanzhong)) : (getDrawableFromResource(mboundView15, R.drawable.shape_login_input)));
                    // read viewModel.payType.get() == 2 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
                    viewModelPayTypeInt2MboundView13AndroidDrawableXuanzhongMboundView13AndroidDrawableShapeLoginInput = ((viewModelPayTypeInt2) ? (getDrawableFromResource(mboundView13, R.drawable.xuanzhong)) : (getDrawableFromResource(mboundView13, R.drawable.shape_login_input)));
                    // read viewModel.payType.get() == 3 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
                    viewModelPayTypeInt3MboundView14AndroidDrawableXuanzhongMboundView14AndroidDrawableShapeLoginInput = ((viewModelPayTypeInt3) ? (getDrawableFromResource(mboundView14, R.drawable.xuanzhong)) : (getDrawableFromResource(mboundView14, R.drawable.shape_login_input)));
                    // read viewModel.payType.get() == 5 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
                    viewModelPayTypeInt5MboundView12AndroidDrawableXuanzhongMboundView12AndroidDrawableShapeLoginInput = ((viewModelPayTypeInt5) ? (getDrawableFromResource(mboundView12, R.drawable.xuanzhong)) : (getDrawableFromResource(mboundView12, R.drawable.shape_login_input)));
        ...
        if ((dirtyFlags & 0x30L) != 0) {
            ...
            this.btPay.setOnClickListener(viewModelClickButtonAndroidViewViewOnClickListener);
            ...
            this.mboundView13.setOnClickListener(viewModelClickXinhangkaPayAndroidViewViewOnClickListener);
            this.mboundView14.setOnClickListener(viewModelClickXianjinPayAndroidViewViewOnClickListener);
            this.mboundView15.setOnClickListener(viewModelClickBossWeixinAndroidViewViewOnClickListener);
            this.mboundView16.setOnClickListener(viewModelClickBossZhifubaoAndroidViewViewOnClickListener);
            this.mboundView9.setOnClickListener(viewModelClickWeixinPayAndroidViewViewOnClickListener);
        }
        if ((dirtyFlags & 0x34L) != 0) {
            // api target 1

            this.btPay.setEnabled(viewModelObButtonEnableGet);
        }
        if ((dirtyFlags & 0x38L) != 0) {
            // api target 1
            ...
            android.databinding.adapters.ViewBindingAdapter.setBackground(this.mboundView11, viewModelPayTypeInt4MboundView11AndroidDrawableXuanzhongMboundView11AndroidDrawableShapeLoginInput);
            android.databinding.adapters.ViewBindingAdapter.setBackground(this.mboundView12, viewModelPayTypeInt5MboundView12AndroidDrawableXuanzhongMboundView12AndroidDrawableShapeLoginInput);
            android.databinding.adapters.ViewBindingAdapter.setBackground(this.mboundView13, viewModelPayTypeInt2MboundView13AndroidDrawableXuanzhongMboundView13AndroidDrawableShapeLoginInput);
            android.databinding.adapters.ViewBindingAdapter.setBackground(this.mboundView14, viewModelPayTypeInt3MboundView14AndroidDrawableXuanzhongMboundView14AndroidDrawableShapeLoginInput);
            android.databinding.adapters.ViewBindingAdapter.setBackground(this.mboundView15, viewModelPayTypeInt6MboundView15AndroidDrawableXuanzhongMboundView15AndroidDrawableShapeLoginInput);
            android.databinding.adapters.ViewBindingAdapter.setBackground(this.mboundView16, viewModelPayTypeInt7MboundView16AndroidDrawableXuanzhongMboundView16AndroidDrawableShapeLoginInput);
        ...
        if ((dirtyFlags & 0x31L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView3, viewModelMChargeInfoPhone);
            android.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView4, viewModelMChargeInfoCardNo);
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.PayViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.vip.PayViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.PayViewModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.vip.PayViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl2 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.PayViewModel value;
        public OnClickListenerImpl2 setValue(ys.app.pad.viewmodel.vip.PayViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl3 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.PayViewModel value;
        public OnClickListenerImpl3 setValue(ys.app.pad.viewmodel.vip.PayViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl4 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.PayViewModel value;
        public OnClickListenerImpl4 setValue(ys.app.pad.viewmodel.vip.PayViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl5 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.PayViewModel value;
        public OnClickListenerImpl5 setValue(ys.app.pad.viewmodel.vip.PayViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl6 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.PayViewModel value;
        public OnClickListenerImpl6 setValue(ys.app.pad.viewmodel.vip.PayViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl7 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.PayViewModel value;
        public OnClickListenerImpl7 setValue(ys.app.pad.viewmodel.vip.PayViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl8 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.vip.PayViewModel value;
        public OnClickListenerImpl8 setValue(ys.app.pad.viewmodel.vip.PayViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static ActivityPayBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityPayBinding>inflate(inflater, ys.app.pad.R.layout.activity_pay, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityPayBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_pay, null, false), bindingComponent);
    }
    @NonNull
    ...
    /* flag mapping
        ...
        flag 5 (0x6L): null
        flag 6 (0x7L): viewModel.payType.get() == 2 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 7 (0x8L): viewModel.payType.get() == 2 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 8 (0x9L): viewModel.seePresenter.get() ? View.VISIBLE : View.GONE
        flag 9 (0xaL): viewModel.seePresenter.get() ? View.VISIBLE : View.GONE
        flag 10 (0xbL): viewModel.payType.get() == 6 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 11 (0xcL): viewModel.payType.get() == 6 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 12 (0xdL): viewModel.payType.get() == 3 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 13 (0xeL): viewModel.payType.get() == 3 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 14 (0xfL): viewModel.payType.get() == 0 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 15 (0x10L): viewModel.payType.get() == 0 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 16 (0x11L): viewModel.payType.get() == 5 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 17 (0x12L): viewModel.payType.get() == 5 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 18 (0x13L): viewModel.payType.get() == 4 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 19 (0x14L): viewModel.payType.get() == 4 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 20 (0x15L): viewModel.payType.get() == 7 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 21 (0x16L): viewModel.payType.get() == 7 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 22 (0x17L): viewModel.payType.get() == 1 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
        flag 23 (0x18L): viewModel.payType.get() == 1 ? @android:drawable/xuanzhong : @android:drawable/shape_login_input
    flag mapping end*/
    //end
}