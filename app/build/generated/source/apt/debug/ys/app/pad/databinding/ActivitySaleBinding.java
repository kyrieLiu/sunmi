...
public class ActivitySaleBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.SaleViewModel mViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.SaleViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.SaleViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.SaleViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModel((ys.app.pad.viewmodel.SaleViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewModel(ys.app.pad.viewmodel.SaleViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.SaleViewModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.SaleViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.SaleViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.SaleViewModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.SaleViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl2 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.SaleViewModel value;
        public OnClickListenerImpl2 setValue(ys.app.pad.viewmodel.SaleViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl3 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.SaleViewModel value;
        public OnClickListenerImpl3 setValue(ys.app.pad.viewmodel.SaleViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static ActivitySaleBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivitySaleBinding>inflate(inflater, ys.app.pad.R.layout.activity_sale, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivitySaleBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_sale, null, false), bindingComponent);
    }
    @NonNull
