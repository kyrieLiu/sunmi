...
public class OutPutRecordListBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.inventory.OutPutRecordModel mViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.inventory.OutPutRecordModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.inventory.OutPutRecordModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.inventory.OutPutRecordModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 5 :
                return onChangeViewModel((ys.app.pad.viewmodel.inventory.OutPutRecordModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.inventory.OutPutRecordModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x20L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.inventory.OutPutRecordModel viewModel = mViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.inventory.OutPutRecordModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.inventory.OutPutRecordModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.inventory.OutPutRecordModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.inventory.OutPutRecordModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl2 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.inventory.OutPutRecordModel value;
        public OnClickListenerImpl2 setValue(ys.app.pad.viewmodel.inventory.OutPutRecordModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static OutPutRecordListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<OutPutRecordListBinding>inflate(inflater, ys.app.pad.R.layout.fragment_out_put_list, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static OutPutRecordListBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.fragment_out_put_list, null, false), bindingComponent);
    }
    @NonNull
