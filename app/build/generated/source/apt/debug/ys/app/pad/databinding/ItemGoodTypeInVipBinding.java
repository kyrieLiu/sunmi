...
public class ItemGoodTypeInVipBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.GoodTypeInVipItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    private android.databinding.InverseBindingListener zhekouTvandroidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // itemViewModel
            ys.app.pad.viewmodel.GoodTypeInVipItemViewModel itemViewModel = mItemViewModel;
            // itemViewModel != null
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.viewmodel.GoodTypeInVipItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.viewmodel.GoodTypeInVipItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.GoodTypeInVipItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.viewmodel.GoodTypeInVipItemViewModel) object, fieldId);
            case 1 :
                return onChangeItemViewModelObGoodCost((android.databinding.ObservableField<java.lang.String>) object, fieldId);
            case 2 :
                return onChangeItemViewModelModel((ys.app.pad.model.GoodTypeInfo) object, fieldId);
            case 3 :
    ...
    private boolean onChangeItemViewModel(ys.app.pad.viewmodel.GoodTypeInVipItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeItemViewModelModel(ys.app.pad.model.GoodTypeInfo ItemViewModelModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.GoodTypeInVipItemViewModel itemViewModel = mItemViewModel;
        android.databinding.ObservableField<java.lang.String> itemViewModelObGoodCost = null;
        ys.app.pad.model.GoodTypeInfo itemViewModelModel = null;
        java.lang.String itemViewModelObGoodCostGet = null;
    ...
    public static ItemGoodTypeInVipBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemGoodTypeInVipBinding>inflate(inflater, ys.app.pad.R.layout.item_good_type_in_vip, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemGoodTypeInVipBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_good_type_in_vip, null, false), bindingComponent);
    }
    @NonNull
