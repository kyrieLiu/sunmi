...
public class ActivityManagerBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.manage.ManagerViewModel mViewModel;
    @Nullable
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.manage.ManagerViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.manage.ManagerViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.manage.ManagerViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModel((ys.app.pad.viewmodel.manage.ManagerViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewModel(ys.app.pad.viewmodel.manage.ManagerViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.manage.ManagerViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x2L) != 0) {
            ...
            this.mboundView4.setOnClickListener(mCallback44);
        }
        if ((dirtyFlags & 0x3L) != 0) {
            // api target 1
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.manage.ManagerViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.manage.ManagerViewModel value) {
            this.value = value;
    ...
    public static class OnClickListenerImpl1 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.manage.ManagerViewModel value;
        public OnClickListenerImpl1 setValue(ys.app.pad.viewmodel.manage.ManagerViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl2 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.manage.ManagerViewModel value;
        public OnClickListenerImpl2 setValue(ys.app.pad.viewmodel.manage.ManagerViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl3 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.manage.ManagerViewModel value;
        public OnClickListenerImpl3 setValue(ys.app.pad.viewmodel.manage.ManagerViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl4 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.manage.ManagerViewModel value;
        public OnClickListenerImpl4 setValue(ys.app.pad.viewmodel.manage.ManagerViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static class OnClickListenerImpl5 implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.manage.ManagerViewModel value;
        public OnClickListenerImpl5 setValue(ys.app.pad.viewmodel.manage.ManagerViewModel value) {
            this.value = value;
            return value == null ? null : this;
        }
        @Override
    ...
    public static ActivityManagerBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityManagerBinding>inflate(inflater, ys.app.pad.R.layout.activity_manager, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityManagerBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_manager, null, false), bindingComponent);
    }
    @NonNull
