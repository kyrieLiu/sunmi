...
public class ItemServiceSearchBinding extends android.databinding.ViewDataBinding  {
    ...
    @NonNull
    private final ys.app.pad.widget.RotateTextView mboundView1;
    @NonNull
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.ServiceSearchItemViewModel mItemViewModel;
    // values
    // listeners
    private OnClickListenerImpl mItemViewModelClickAddShoppingButtonAndroidViewViewOnClickListener;
    // Inverse Binding Event Handlers

    public ItemServiceSearchBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.mboundView1 = (ys.app.pad.widget.RotateTextView) bindings[1];
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.viewmodel.ServiceSearchItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.viewmodel.ServiceSearchItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.ServiceSearchItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.viewmodel.ServiceSearchItemViewModel) object, fieldId);
            case 1 :
    ...
    private boolean onChangeItemViewModel(ys.app.pad.viewmodel.ServiceSearchItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.ServiceSearchItemViewModel itemViewModel = mItemViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.ServiceSearchItemViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.ServiceSearchItemViewModel value) {
            this.value = value;
    ...
    @NonNull
    public static ItemServiceSearchBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static ItemServiceSearchBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemServiceSearchBinding>inflate(inflater, ys.app.pad.R.layout.item_service_search, root, attachToRoot, bindingComponent);
    }
    @NonNull
    public static ItemServiceSearchBinding inflate(@NonNull android.view.LayoutInflater inflater) {
        return inflate(inflater, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static ItemServiceSearchBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_service_search, null, false), bindingComponent);
    }
    @NonNull
    public static ItemServiceSearchBinding bind(@NonNull android.view.View view) {
        return bind(view, android.databinding.DataBindingUtil.getDefaultComponent());
    }
    @NonNull
    public static ItemServiceSearchBinding bind(@NonNull android.view.View view, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        if (!"layout/item_service_search_0".equals(view.getTag())) {
            throw new RuntimeException("view tag isn't correct on view:" + view.getTag());
        }
        return new ItemServiceSearchBinding(bindingComponent, view);
    }
    /* flag mapping
