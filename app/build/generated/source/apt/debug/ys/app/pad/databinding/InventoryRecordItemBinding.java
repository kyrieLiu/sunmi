...
public class InventoryRecordItemBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.inventory.InventoryRecordItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.viewmodel.inventory.InventoryRecordItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.viewmodel.inventory.InventoryRecordItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.inventory.InventoryRecordItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.viewmodel.inventory.InventoryRecordItemViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItemViewModel(ys.app.pad.viewmodel.inventory.InventoryRecordItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.inventory.InventoryRecordItemViewModel itemViewModel = mItemViewModel;
        ...
        ys.app.pad.model.InventoryRecordsInfo.InventoryList2Bean itemViewModelModel = null;
    ...
    public static InventoryRecordItemBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<InventoryRecordItemBinding>inflate(inflater, ys.app.pad.R.layout.item_inventory_record, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static InventoryRecordItemBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_inventory_record, null, false), bindingComponent);
    }
    @NonNull
