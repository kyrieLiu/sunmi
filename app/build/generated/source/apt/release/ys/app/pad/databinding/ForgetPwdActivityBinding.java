...
public class ForgetPwdActivityBinding extends android.databinding.ViewDataBinding implements android.databinding.generated.callback.OnClickListener.Listener {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.ForgetPwdViewModel mViewModel;
    @Nullable
    ...
    private android.databinding.InverseBindingListener mboundView1androidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            ys.app.pad.viewmodel.ForgetPwdViewModel viewModel = mViewModel;
            // viewModel != null
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ys.app.pad.viewmodel.ForgetPwdViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ys.app.pad.viewmodel.ForgetPwdViewModel ViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.ForgetPwdViewModel getViewModel() {
        return mViewModel;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 3 :
                return onChangeViewModel((ys.app.pad.viewmodel.ForgetPwdViewModel) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeViewModel(ys.app.pad.viewmodel.ForgetPwdViewModel ViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.ForgetPwdViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.ForgetPwdViewModel value) {
            this.value = value;
    ...
    public static ForgetPwdActivityBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ForgetPwdActivityBinding>inflate(inflater, ys.app.pad.R.layout.activity_forget_pwd, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ForgetPwdActivityBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.activity_forget_pwd, null, false), bindingComponent);
    }
    @NonNull
