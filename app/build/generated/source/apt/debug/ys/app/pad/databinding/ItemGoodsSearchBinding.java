...
public class ItemGoodsSearchBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private ys.app.pad.viewmodel.GoodsSearchItemViewModel mItemViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((ys.app.pad.viewmodel.GoodsSearchItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable ys.app.pad.viewmodel.GoodsSearchItemViewModel ItemViewModel) {
    ...
    @Nullable
    public ys.app.pad.viewmodel.GoodsSearchItemViewModel getItemViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((ys.app.pad.viewmodel.GoodsSearchItemViewModel) object, fieldId);
            case 1 :
    ...
    private boolean onChangeItemViewModel(ys.app.pad.viewmodel.GoodsSearchItemViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        ys.app.pad.viewmodel.GoodsSearchItemViewModel itemViewModel = mItemViewModel;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private ys.app.pad.viewmodel.GoodsSearchItemViewModel value;
        public OnClickListenerImpl setValue(ys.app.pad.viewmodel.GoodsSearchItemViewModel value) {
            this.value = value;
    ...
    public static ItemGoodsSearchBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemGoodsSearchBinding>inflate(inflater, ys.app.pad.R.layout.item_goods_search, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemGoodsSearchBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(ys.app.pad.R.layout.item_goods_search, null, false), bindingComponent);
    }
    @NonNull
